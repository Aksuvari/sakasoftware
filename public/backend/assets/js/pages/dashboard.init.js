var options = {
    series: [{name: "2018", type: "line", data: [20, 34, 27, 59, 37, 26, 38, 25]}, {
        name: "2019",
        data: [10, 24, 17, 49, 27, 16, 28, 15],
        type: "area"
    }],
    chart: {height: 260, type: "line", toolbar: {show: !1}, zoom: {enabled: !1}},
...
options = {
    series: [{name: "Series A", data: [11, 17, 15, 15, 21, 14]}, {
        name: "Series B",
        data: [13, 23, 20, 8, 13, 27]
    }, {name: "Series C", data: [44, 55, 41, 67, 22, 43]}],
    chart: {type: "bar", height: 260, stacked: !0, toolbar: {show: !1}, zoom: {enabled: !0}},
...
options = {
    ...
    chart: {height: 230, type: "scatter", toolbar: {show: !1}, zoom: {enabled: !0, type: "xy"}},
    colors: ["#3b5de7", "#45cb85"],
    xaxis: {tickAmount: 10},
    legend: {position: "top"},
    yaxis: {tickAmount: 7}
};
(chart = new ApexCharts(document.querySelector("#scatter-chart"), options)).render(), $("#usa-vectormap").vectorMap({
    map: "us_merc_en",

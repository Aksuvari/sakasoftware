        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('Emails.update',$items->id)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Sunucu Portu" name="port" value="{{$items->port}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Host</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Host Adresi" name="host" value="{{$items->host}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Username</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Mail Kullanıcı Adı" name="username" value="{{$items->username}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Password</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="password" placeholder="Mail Şifresi" name="password" value="{{$items->password}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Gönderen
                                        (From)</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Gönderen Kişi Mail" name="from" value="{{$items->from}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Alan Kişi Mail" name="to" value="{{$items->to}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Başlık</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Mail Başlığı" name="title" value="{{$items->title}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Protocol</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Protocol" name="protocol" value="{{$items->protocol}}">
                                    </div>
                                </div>
                            </div>
                        </div>

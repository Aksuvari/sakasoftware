        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Sitemizde bulunan slide</p>
                    <form action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="checkbox" class="allowBtn button_usage_btn" id="switch" switch="bool" name="allowBtn">
                            <label for="switch" data-on-label="Aktif" data-off-label="Pasif"></label>
                        </div>
                    </div>

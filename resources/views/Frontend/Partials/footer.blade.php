            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copyright d-block d-md-flex justify-content-between align-items-center">
                        ...
                        <ul>
                            <li><a href="https://www.facebook.com/sakasoftware38" target="_blank"><i class="fa fa-facebook-square"></i></a></li>
                            <li><a href="https://twitter.com/SoftwareSaka" target="_blank"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="https://www.instagram.com/saka.software/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="https://www.youtube.com/channel/UCZ7fRUY5d26w9L_d669eJdA" target="_blank"><i class="fa fa-youtube"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
